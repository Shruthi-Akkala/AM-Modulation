...
class IQ_Modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_1 = blocks.wavfile_source('C:\\Users\\shrut\\Downloads\\vocal.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\shrut\\Downloads\\background.wav', True)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_sub_xx_0 = blocks.sub_ff(1)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'E:\\IITB_TA_Lab\\Data1.dat', False)
