...
class SSBSC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SSBSC")
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(640000, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(640000, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_sink_x_1, 0))
...
def main(top_block_cls=SSBSC, options=None):
